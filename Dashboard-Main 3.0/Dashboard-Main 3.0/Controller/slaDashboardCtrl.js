    ...
    $scope.onClickChartType=function(type){
       ...
       // $scope.aggregationsSpecialStackedGraphData = aggregationsData.drillStackedGraphData;
        if($scope.selectedChartType=="trended"){
            ...
            dashboardDataProcessFactory.processAggregationsGraphData($scope,dashboardDataProcessFactory.processGraphData($scope,$scope.aggregationsSpecialStackedGraphData))
        }
